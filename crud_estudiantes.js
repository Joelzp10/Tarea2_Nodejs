...
crud_estudiantes.leer=(req,res) => {
    ...
    conectar.query('SELECT id_estudiantes,carne,nombres,apeillidos,direccion,telefono,correo_electronico,id_tipo_sangre,date_format(fecha_nacimiento,"%d-%m-%Y") as fecha_nacimiento FROM estudiantes',(error,results)=>{
        if(error){
            throw error;
        }else{
...
crud_estudiantes.cud=(req,res) => {
    ...
    const apeillidos=req.body.txt_apeillidos;
    ...
    if(btn_crear){
        ...
        {carne:carne,nombres:nombres,apeillidos:apeillidos,direccion:direccion,telefono:telefono,correo_electronico:correo_electronico,id_tipo_sangre:id_tipo_sangre,fecha_nacimiento:fecha_nacimiento},(error,results)=>{
                if(error){
                    console.log(error);
                }else{
                    res.redirect('/');
    ...
    if(btn_actualizar){
        ...
        [{carne:carne,nombres:nombres,apeillidos:apeillidos,direccion:direccion,telefono:telefono,correo_electronico:correo_electronico,id_tipo_sangre:id_tipo_sangre,fecha_nacimiento:fecha_nacimiento},id_estudiantes],(error,results)=>{
                if(error){
                    console.log(error);
                }else{
                    res.redirect('/')
